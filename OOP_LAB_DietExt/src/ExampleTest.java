...
public class ExampleTest {
    ...
    public void testAll()  {
        ...
        System.out.println(food.getRawMaterial("Sugar"));
        ...
        System.out.println("Raw Mats: "+food.rawMaterials());
        System.out.println("Prods: "+food.products());
        System.out.println("Ricette: "+food.recipes());
        //System.out.println("Stat ricetta: calories "+r.getCalories()+" proteins "+r.getProteins()+" carbs "+r.getCarbs()+" fat "+r.getFat());
        System.out.println(r.toString());
        Menu menu = food.createMenu("M1");
        assertNotNull("Missing recipe",menu);
        menu.addRecipe("Pasta al Pomodoro", 50).
        	 addProduct("Crackers");
        System.out.println("Stat menu: calories "+menu.getCalories()+" proteins "+menu.getProteins()+" carbs "+menu.getCarbs()+" fat "+menu.getFat());

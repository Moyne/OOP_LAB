...
public void test() throws EvaluationsException {
    ...
    //System.out.println(ev.getPointsOfAGivenAuthor("moyne"));
    //System.out.println(ev.getTitlesOfAGivenAuthor("moyne"));
    //ev.addPaper("ok", "j1a");
    //System.out.println(ev.getMembers("moyne"));
    System.out.println(ev.getGroupNamesOfAGivenDiscipline("d2"));
    System.out.println(ev.getJournalNamesOfAGivenDiscipline("d2"));
//    ev.addJournal("moyne", "Disc", 50);
    //System.out.println(ev.getMembers("g1"));
}
}
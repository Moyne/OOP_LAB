...
public class ExampleTest {
	...
	public void test() throws NoSuchPatient, NoSuchDoctor, IOException {
		...
		Reader r=new FileReader("ospedale.txt");
		hospital.loadData(r);
		...
		System.out.println(hospital.doctorsByNumPatients());
		System.out.println(hospital.idleDoctors());
		System.out.println(hospital.busyDoctors());
		System.out.println(hospital.countPatientsPerSpecialization());
	}

...
public class Food {
	...
	public Collection<NutritionalElement> rawMaterials(){
		rawMats.sort((e1,e2)->e1.getName().compareTo(e2.getName()));
		return rawMats;
	}
	...
	public Collection<NutritionalElement> products(){
		products.sort((e1,e2)->e1.getName().compareTo(e2.getName()));
		return products;
	}
	...
	public Collection<NutritionalElement> recipes(){
		recipes.sort((e1,e2)->e1.getName().compareTo(e2.getName()));
		return recipes;
	}
